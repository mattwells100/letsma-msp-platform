...
_SECRET_NAMES = [
    ...
    "VUZION-CLOUDBLUE-CLIENT-ID", "VUZION-CLOUDBLUE-REALM",
]
...
class Settings:
    ...
    VUZION_CLOUDBLUE_CLIENT_ID: str = os.getenv("VUZION_CLOUDBLUE_CLIENT_ID", "")
    VUZION_CLOUDBLUE_REALM: str = os.getenv("VUZION_CLOUDBLUE_REALM", "")
    ...
    AUTH_TENANT_ID: str = os.getenv("AUTH_TENANT_ID", "")
    AUTH_CLIENT_ID: str = os.getenv("AUTH_CLIENT_ID", "")
    AUTH_CLIENT_SECRET: str = os.getenv("AUTH_CLIENT_SECRET", "")
    AUTH_REDIRECT_URI: str = os.getenv("AUTH_REDIRECT_URI", "http://localhost:8000/auth/callback")
